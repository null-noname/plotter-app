 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const al=$m("rcb"),ib=new Zs(3e4,6e4);class sb{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!(!((e=ke().grecaptcha)===null||e===void 0)&&e.render)}load(e,t=""){return V(ob(t),e,"argument-error"),this.shouldResolveImmediately(t)&&sf(ke().grecaptcha)?Promise.resolve(ke().grecaptcha):new Promise((r,i)=>{const s=ke().setTimeout(()=>{i(Ce(e,"network-request-failed"))},ib.get());ke()[al]=()=>{ke().clearTimeout(s),delete ke()[al];const c=ke().grecaptcha;if(!c||!sf(c)){i(Ce(e,"internal-error"));return}const l=c.render;c.render=(u,d)=>{const p=l(u,d);return this.counter++,p},this.hostLanguage=t,r(c)};const o=`${RE()}?${bi({onload:al,render:"explicit",hl:t})}`;Iu(o).catch(()=>{clearTimeout(s),i(Ce(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!(!((t=ke().grecaptcha)===null||t===void 0)&&t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function ob(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class ab{async load(e){return new tb(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yb=new Zs(2e3,1e4);async function ug(n,e,t){if(ve(n.app))return Promise.reject(Ce(n,"operation-not-supported-in-this-environment"));const r=Ie(n);Ri(n,e,on);const i=Ar(r,t);return new Gt(r,"signInViaPopup",e,i).executeNotNull()}async function vb(n,e,t){const r=q(n);if(ve(r.auth.app))return Promise.reject(Ce(r.auth,"operation-not-supported-in-this-environment"));Ri(r.auth,e,on);const i=Ar(r.auth,t);return new Gt(r.auth,"reauthViaPopup",e,i,r).executeNotNull()}async function Ib(n,e,t){const r=q(n);Ri(r.auth,e,on);const i=Ar(r.auth,t);return new Gt(r.auth,"linkViaPopup",e,i,r).executeNotNull()}class Gt extends lg{constructor(e,t,r,i,s){super(e,t,i,s),this.provider=r,this.authWindow=null,this.pollId=null,Gt.currentPopupAction&&Gt.currentPopupAction.cancel(),Gt.currentPopupAction=this}async executeNotNull(){const e=await this.execute();return V(e,this.auth,"internal-error"),e}async onExecution(){Rt(this.filter.length===1,"Popup operations only handle one event");const e=io();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],e),this.authWindow.associatedEvent=e,this.resolver._originValidation(this.auth).catch(t=>{this.reject(t)}),this.resolver._isIframeWebStorageSupported(this.auth,t=>{t||this.reject(Ce(this.auth,"web-storage-unsupported"))}),this.pollUserCancellation()}get eventId(){var e;return((e=this.authWindow)===null||e===void 0?void 0:e.associatedEvent)||null}cancel(){this.reject(Ce(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,Gt.currentPopupAction=null}pollUserCancellation(){const e=()=>{var t,r;if(!((r=(t=this.authWindow)===null||t===void 0?void 0:t.window)===null||r===void 0)&&r.closed){this.pollId=window.setTimeout(()=>{this.pollId=null,this.reject(Ce(this.auth,"popup-closed-by-user"))},8e3);return}this.pollId=window.setTimeout(e,yb.get())};e()}}Gt.currentPopupAction=null;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fb=new Zs(3e4,6e4);function _f(){const n=ke().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Ub(n){return new Promise((e,t)=>{var r,i,s;function o(){_f(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{_f(),t(Ce(n,"network-request-failed"))},timeout:Fb.get()})}if(!((i=(r=ke().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=ke().gapi)===null||s===void 0)&&s.load)o();else{const c=$m("iframefcb");return ke()[c]=()=>{gapi.load?o():t(Ce(n,"network-request-failed"))},Iu(`${PE()}?onload=${c}`).catch(l=>t(l))}}).catch(e=>{throw ia=null,e})}let ia=null;function Bb(n){return ia=ia||Ub(n),ia}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TA=20;class bA extends pg{constructor(){super(...arguments),this.passiveListeners=new Set,this.initPromise=new Promise(e=>{this.resolveInitialized=e})}addPassiveListener(e){this.passiveListeners.add(e)}removePassiveListener(e){this.passiveListeners.delete(e)}resetRedirect(){this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1}onEvent(e){return this.resolveInitialized(),this.passiveListeners.forEach(t=>t(e)),super.onEvent(e)}async initialized(){await this.initPromise}}function AA(n,e,t=null){return{type:e,eventId:t,urlResponse:null,sessionId:PA(),postBody:null,tenantId:n.tenantId,error:Ce(n,"no-auth-event")}}function RA(n,e){return Al()._set(Rl(n),e)}async function Ef(n){const e=await Al()._get(Rl(n));return e&&await Al()._remove(Rl(n)),e}function SA(n,e){var t,r;const i=CA(e);if(i.includes("/__/auth/callback")){const s=sa(i),o=s.firebaseError?kA(decodeURIComponent(s.firebaseError)):null,c=(r=(t=o==null?void 0:o.code)===null||t===void 0?void 0:t.split("auth/"))===null||r===void 0?void 0:r[1],l=c?Ce(c):null;return l?{type:n.type,eventId:n.eventId,tenantId:n.tenantId,error:l,urlResponse:null,sessionId:null,postBody:null}:{type:n.type,eventId:n.eventId,tenantId:n.tenantId,sessionId:n.sessionId,urlResponse:i,postBody:null}}return null}function PA(){const n=[],e="1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";for(let t=0;t<TA;t++){const r=Math.floor(Math.random()*e.length);n.push(e.charAt(r))}return n.join("")}function Al(){return ft(Ja)}function Rl(n){return or("authEvent",n.config.apiKey,n.name)}function kA(n){try{return JSON.parse(n)}catch{return null}}function CA(n){const e=sa(n),t=e.link?decodeURIComponent(e.link):void 0,r=sa(t).link,i=e.deep_link_id?decodeURIComponent(e.deep_link_id):void 0;return sa(i).link||i||r||t||n}function sa(n){if(!(n!=null&&n.includes("?")))return{};const[e,...t]=n.split("?");return Jr(t.join("?"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dg{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class sR{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Ve.UNAUTHENTICATED))}shutdown(){}}class oR{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class aR{constructor(e){this.t=e,this.currentUser=Ve.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){$(this.o===void 0);let r=this.i;const i=l=>this.i!==r?(r=this.i,t(l)):Promise.resolve();let s=new $e;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new $e,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const l=s;e.enqueueRetryable(async()=>{await l.promise,await i(this.currentUser)})},c=l=>{N("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(l=>c(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?c(l):(N("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new $e)}},0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(N("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?($(typeof r.accessToken=="string"),new Dg(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return $(e===null||typeof e=="string"),new Ve(e)}}class cR{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=Ve.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class lR{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new cR(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(Ve.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class uR{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class hR{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){$(this.o===void 0);const r=s=>{s.error!=null&&N("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.R;return this.R=s.token,N("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(s.token):Promise.resolve()};this.o=s=>{e.enqueueRetryable(()=>r(s))};const i=s=>{N("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(s=>i(s)),setTimeout(()=>{if(!this.appCheck){const s=this.A.getImmediate({optional:!0});s?i(s):N("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?($(typeof t.token=="string"),this.R=t.token,new uR(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dl extends Fg{constructor(e,t){super(),this._e=e,this.currentSequenceNumber=t}}function De(n,e){const t=M(n);return Vt.F(t._e,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RS{Pt(e){return De(e,"globals")}getSessionToken(e){return this.Pt(e).get("sessionToken").next(t=>{const r=t==null?void 0:t.value;return r?we.fromUint8Array(r):we.EMPTY_BYTE_STRING})}setSessionToken(e,t){return this.Pt(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ek{constructor(e,t){this.Xa=e,this.serializer=t,this.metadata=new $e,this.buffer=new Uint8Array,this.eu=function(){return new TextDecoder("utf-8")}(),this.tu().then(r=>{r&&r.ua()?this.metadata.resolve(r.aa.metadata):this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pk=-1;let Ee=class extends go{constructor(e,t,r,i){super(e,t,r,i),this.type="firestore",this._queue=new Np,this._persistenceKey=(i==null?void 0:i.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Np(e),this._firestoreClient=void 0,await e}}};function mk(n,e){const t=za(),r="(default)",i=Ai(t,"firestore").getImmediate({identifier:r});if(!i._initialized){const s=sm("firestore");s&&by(i,...s)}return i}function ze(n){if(n._terminated)throw new D(P.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||Cy(n),n._firestoreClient}function Cy(n){var e,t,r;const i=n._freezeSettings(),s=function(c,l,u,d){return new UR(c,l,u,d.host,d.ssl,d.experimentalForceLongPolling,d.experimentalAutoDetectLongPolling,wy(d.experimentalLongPollingOptions),d.useFetchStreams)}(n._databaseId,((e=n._app)===null||e===void 0?void 0:e.options.appId)||"",n._persistenceKey,i);n._componentsProvider||!((t=i.localCache)===null||t===void 0)&&t._offlineComponentProvider&&(!((r=i.localCache)===null||r===void 0)&&r._onlineComponentProvider)&&(n._componentsProvider={_offline:i.localCache._offlineComponentProvider,_online:i.localCache._onlineComponentProvider}),n._firestoreClient=new rk(n._authCredentials,n._appCheckCredentials,n._queue,s,n._componentsProvider&&function(c){const l=c==null?void 0:c._online.build();return{_offline:c==null?void 0:c._offline.build(l),_online:l}}(n._componentsProvider))}function gk(n,e){Ft("enableIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const t=n._freezeSettings();return xy(n,Hs.provider,{build:r=>new gy(r,t.cacheSizeBytes,e==null?void 0:e.forceOwnership)}),Promise.resolve()}async function _k(n){Ft("enableMultiTabIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const e=n._freezeSettings();xy(n,Hs.provider,{build:t=>new ZP(t,e.cacheSizeBytes)})}function xy(n,e,t){if((n=ee(n,Ee))._firestoreClient||n._terminated)throw new D(P.FAILED_PRECONDITION,"Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");if(n._componentsProvider||n._getSettings().localCache)throw new D(P.FAILED_PRECONDITION,"SDK cache is already specified.");n._componentsProvider={_online:e,_offline:t},Cy(n)}function yk(n){if(n._initialized&&!n._terminated)throw new D(P.FAILED_PRECONDITION,"Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");const e=new $e;return n._queue.enqueueAndForgetEvenWhileRestricted(async()=>{try{await async function(r){if(!Vt.D())return Promise.resolve();const i=r+"main";await Vt.delete(i)}(th(n._databaseId,n._persistenceKey)),e.resolve()}catch(t){e.reject(t)}}),e.promise}function vk(n){return function(t){const r=new $e;return t.asyncQueue.enqueueAndForget(async()=>qP(await Ih(t),r)),r.promise}(ze(n=ee(n,Ee)))}function Ik(n){return sk(ze(n=ee(n,Ee)))}function wk(n){return ok(ze(n=ee(n,Ee)))}function Ek(n,e){const t=ze(n=ee(n,Ee)),r=new fk;return uk(t,n._databaseId,e,r),r}function Tk(n,e){return hk(ze(n=ee(n,Ee)),e).then(t=>t?new st(n,null,t.query):null)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tc(n,e,t){let r;return r=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,r}class Ok extends Vh{constructor(e){super(),this.firestore=e}convertBytes(e){return new Bt(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new pe(this.firestore,null,t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wk(){return new _o("deleteField")}function Fn(){return new Th("serverTimestamp")}function Gk(...n){return new bh("arrayUnion",n)}function Kk(...n){return new Ah("arrayRemove",n)}function Hk(n){return new Rh("increment",n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zl(n){return Yk(n,["next","error","complete"])}function Yk(n,e){if(typeof n!="object"||n===null)return!1;const t=n;for(const r of e)if(r in t&&typeof t[r]=="function")return!0;return!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xk{enableIndexedDbPersistence(e,t){return gk(e._delegate,{forceOwnership:t})}enableMultiTabIndexedDbPersistence(e){return _k(e._delegate)}clearIndexedDbPersistence(e){return yk(e._delegate)}}class Gy{constructor(e,t,r){this._delegate=t,this._persistenceProvider=r,this.INTERNAL={delete:()=>this.terminate()},e instanceof Dn||(this._appCompat=e)}get _databaseId(){return this._delegate._databaseId}settings(e){const t=this._delegate._getSettings();!e.merge&&t.host!==e.host&&Ft("You are overriding the original host. If you did not intend to override your settings, use {merge: true}."),e.merge&&(e=Object.assign(Object.assign({},t),e),delete e.merge),this._delegate._setSettings(e)}useEmulator(e,t,r={}){by(this._delegate,e,t,r)}enableNetwork(){return Ik(this._delegate)}disableNetwork(){return wk(this._delegate)}enablePersistence(e){let t=!1,r=!1;return e&&(t=!!e.synchronizeTabs,r=!!e.experimentalForceOwningTab,Ey("synchronizeTabs",t,"experimentalForceOwningTab",r)),t?this._persistenceProvider.enableMultiTabIndexedDbPersistence(this):this._persistenceProvider.enableIndexedDbPersistence(this,r)}clearPersistence(){return this._persistenceProvider.clearIndexedDbPersistence(this)}terminate(){return this._appCompat&&(this._appCompat._removeServiceInstance("firestore-compat"),this._appCompat._removeServiceInstance("firestore")),this._delegate._delete()}waitForPendingWrites(){return vk(this._delegate)}onSnapshotsInSync(e){return qk(this._delegate,e)}get app(){if(!this._appCompat)throw new D("failed-precondition","Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._appCompat}collection(e){try{return new Ti(this,gt(this._delegate,e))}catch(t){throw tt(t,"collection()","Firestore.collection()")}}doc(e){try{return new yt(this,fe(this._delegate,e))}catch(t){throw tt(t,"doc()","Firestore.doc()")}}collectionGroup(e){try{return new et(this,dk(this._delegate,e))}catch(t){throw tt(t,"collectionGroup()","Firestore.collectionGroup()")}}runTransaction(e){return jk(this._delegate,t=>e(new Ky(this,t)))}batch(){return ze(this._delegate),new Hy(new jy(this._delegate,e=>Fi(this._delegate,e)))}loadBundle(e){return Ek(this._delegate,e)}namedQuery(e){return Tk(this._delegate,e).then(t=>t?new et(this,t):null)}}class Ac extends Vh{constructor(e){super(),this.firestore=e}convertBytes(e){return new Wy(new Bt(e))}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return yt.forKey(t,this.firestore,null)}}function Zk(n){rR(n)}class Ky{constructor(e,t){this._firestore=e,this._delegate=t,this._userDataWriter=new Ac(e)}get(e){const t=sr(e);return this._delegate.get(t).then(r=>new Js(this._firestore,new nn(this._firestore._delegate,this._userDataWriter,r._key,r._document,r.metadata,t.converter)))}set(e,t,r){const i=sr(e);return r?(Mh("Transaction.set",r),this._delegate.set(i,t,r)):this._delegate.set(i,t),this}update(e,t,r,...i){const s=sr(e);return arguments.length===2?this._delegate.update(s,t):this._delegate.update(s,t,r,...i),this}delete(e){const t=sr(e);return this._delegate.delete(t),this}}class Hy{constructor(e){this._delegate=e}set(e,t,r){const i=sr(e);return r?(Mh("WriteBatch.set",r),this._delegate.set(i,t,r)):this._delegate.set(i,t),this}update(e,t,r,...i){const s=sr(e);return arguments.length===2?this._delegate.update(s,t):this._delegate.update(s,t,r,...i),this}delete(e){const t=sr(e);return this._delegate.delete(t),this}commit(){return this._delegate.commit()}}class Er{constructor(e,t,r){this._firestore=e,this._userDataWriter=t,this._delegate=r}fromFirestore(e,t){const r=new Ss(this._firestore._delegate,this._userDataWriter,e._key,e._document,e.metadata,null);return this._delegate.fromFirestore(new Ys(this._firestore,r),t??{})}toFirestore(e,t){return t?this._delegate.toFirestore(e,t):this._delegate.toFirestore(e)}static getInstance(e,t){const r=Er.INSTANCES;let i=r.get(e);i||(i=new WeakMap,r.set(e,i));let s=i.get(t);return s||(s=new Er(e,new Ac(e),t),i.set(t,s)),s}}Er.INSTANCES=new WeakMap;class yt{constructor(e,t){this.firestore=e,this._delegate=t,this._userDataWriter=new Ac(e)}static forPath(e,t,r){if(e.length%2!==0)throw new D("invalid-argument",`Invalid document reference. Document references must have an even number of segments, but ${e.canonicalString()} has ${e.length}`);return new yt(t,new pe(t._delegate,r,new L(e)))}static forKey(e,t,r){return new yt(t,new pe(t._delegate,r,e))}get id(){return this._delegate.id}get parent(){return new Ti(this.firestore,this._delegate.parent)}get path(){return this._delegate.path}collection(e){try{return new Ti(this.firestore,gt(this._delegate,e))}catch(t){throw tt(t,"collection()","DocumentReference.collection()")}}isEqual(e){return e=q(e),e instanceof pe?Py(this._delegate,e):!1}set(e,t){t=Mh("DocumentReference.set",t);try{return t?Lp(this._delegate,e,t):Lp(this._delegate,e)}catch(r){throw tt(r,"setDoc()","DocumentReference.set()")}}update(e,t,...r){try{return arguments.length===1?wr(this._delegate,e):wr(this._delegate,e,t,...r)}catch(i){throw tt(i,"updateDoc()","DocumentReference.update()")}}delete(){return bc(this._delegate)}onSnapshot(...e){const t=Qy(e),r=Jy(e,i=>new Js(this.firestore,new nn(this.firestore._delegate,this._userDataWriter,i._key,i._document,i.metadata,this._delegate.converter)));return Mi(this._delegate,t,r)}get(e){let t;return(e==null?void 0:e.source)==="cache"?t=Mk(this._delegate):(e==null?void 0:e.source)==="server"?t=Fk(this._delegate):t=xr(this._delegate),t.then(r=>new Js(this.firestore,new nn(this.firestore._delegate,this._userDataWriter,r._key,r._document,r.metadata,this._delegate.converter)))}withConverter(e){return new yt(this.firestore,e?this._delegate.withConverter(Er.getInstance(this.firestore,e)):this._delegate.withConverter(null))}}function tt(n,e,t){return n.message=n.message.replace(e,t),n}function Qy(n){for(const e of n)if(typeof e=="object"&&!Zl(e))return e;return{}}function Jy(n,e){var t,r;let i;return Zl(n[0])?i=n[0]:Zl(n[1])?i=n[1]:typeof n[0]=="function"?i={next:n[0],error:n[1],complete:n[2]}:i={next:n[1],error:n[2],complete:n[3]},{next:s=>{i.next&&i.next(e(s))},error:(t=i.error)===null||t===void 0?void 0:t.bind(i),complete:(r=i.complete)===null||r===void 0?void 0:r.bind(i)}}class Js{constructor(e,t){this._firestore=e,this._delegate=t}get ref(){return new yt(this._firestore,this._delegate.ref)}get id(){return this._delegate.id}get metadata(){return this._delegate.metadata}get exists(){return this._delegate.exists()}data(e){return this._delegate.data(e)}get(e,t){return this._delegate.get(e,t)}isEqual(e){return zy(this._delegate,e._delegate)}}class Ys extends Js{data(e){const t=this._delegate.data(e);return this._delegate._converter||iR(t!==void 0),t}}class et{constructor(e,t){this.firestore=e,this._delegate=t,this._userDataWriter=new Ac(e)}where(e,t,r){try{return new et(this.firestore,Oe(this._delegate,By(e,t,r)))}catch(i){throw tt(i,/(orderBy|where)\(\)/,"Query.$1()")}}orderBy(e,t){try{return new et(this.firestore,Oe(this._delegate,Cr(e,t)))}catch(r){throw tt(r,/(orderBy|where)\(\)/,"Query.$1()")}}limit(e){try{return new et(this.firestore,Oe(this._delegate,kk(e)))}catch(t){throw tt(t,"limit()","Query.limit()")}}limitToLast(e){try{return new et(this.firestore,Oe(this._delegate,Ck(e)))}catch(t){throw tt(t,"limitToLast()","Query.limitToLast()")}}startAt(...e){try{return new et(this.firestore,Oe(this._delegate,xk(...e)))}catch(t){throw tt(t,"startAt()","Query.startAt()")}}startAfter(...e){try{return new et(this.firestore,Oe(this._delegate,Dk(...e)))}catch(t){throw tt(t,"startAfter()","Query.startAfter()")}}endBefore(...e){try{return new et(this.firestore,Oe(this._delegate,Nk(...e)))}catch(t){throw tt(t,"endBefore()","Query.endBefore()")}}endAt(...e){try{return new et(this.firestore,Oe(this._delegate,Vk(...e)))}catch(t){throw tt(t,"endAt()","Query.endAt()")}}isEqual(e){return ky(this._delegate,e._delegate)}get(e){let t;return(e==null?void 0:e.source)==="cache"?t=Uk(this._delegate):(e==null?void 0:e.source)==="server"?t=Bk(this._delegate):t=Nr(this._delegate),t.then(r=>new eu(this.firestore,new Mn(this.firestore._delegate,this._userDataWriter,this._delegate,r._snapshot)))}onSnapshot(...e){const t=Qy(e),r=Jy(e,i=>new eu(this.firestore,new Mn(this.firestore._delegate,this._userDataWriter,this._delegate,i._snapshot)));return Mi(this._delegate,t,r)}withConverter(e){return new et(this.firestore,e?this._delegate.withConverter(Er.getInstance(this.firestore,e)):this._delegate.withConverter(null))}}class e0{constructor(e,t){this._firestore=e,this._delegate=t}get type(){return this._delegate.type}get doc(){return new Ys(this._firestore,this._delegate.doc)}get oldIndex(){return this._delegate.oldIndex}get newIndex(){return this._delegate.newIndex}}class eu{constructor(e,t){this._firestore=e,this._delegate=t}get query(){return new et(this._firestore,this._delegate.query)}get metadata(){return this._delegate.metadata}get size(){return this._delegate.size}get empty(){return this._delegate.empty}get docs(){return this._delegate.docs.map(e=>new Ys(this._firestore,e))}docChanges(e){return this._delegate.docChanges(e).map(t=>new e0(this._firestore,t))}forEach(e,t){this._delegate.forEach(r=>{e.call(t,new Ys(this._firestore,r))})}isEqual(e){return zy(this._delegate,e._delegate)}}class Ti extends et{constructor(e,t){super(e,t),this.firestore=e,this._delegate=t}get id(){return this._delegate.id}get path(){return this._delegate.path}get parent(){const e=this._delegate.parent;return e?new yt(this.firestore,e):null}doc(e){try{return e===void 0?new yt(this.firestore,fe(this._delegate)):new yt(this.firestore,fe(this._delegate,e))}catch(t){throw tt(t,"doc()","CollectionReference.doc()")}}add(e){return vo(this._delegate,e).then(t=>new yt(this.firestore,t))}isEqual(e){return Py(this._delegate,e._delegate)}withConverter(e){return new Ti(this.firestore,e?this._delegate.withConverter(Er.getInstance(this.firestore,e)):this._delegate.withConverter(null))}}function sr(n){return ee(n,pe)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nr{constructor(e){this._delegate=e}static serverTimestamp(){const e=Fn();return e._methodName="FieldValue.serverTimestamp",new nr(e)}static delete(){const e=Wk();return e._methodName="FieldValue.delete",new nr(e)}static arrayUnion(...e){const t=Gk(...e);return t._methodName="FieldValue.arrayUnion",new nr(t)}static arrayRemove(...e){const t=Kk(...e);return t._methodName="FieldValue.arrayRemove",new nr(t)}static increment(e){const t=Hk(e);return t._methodName="FieldValue.increment",new nr(t)}isEqual(e){return this._delegate.isEqual(e._delegate)}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t0={Firestore:Gy,GeoPoint:mc,Timestamp:de,Blob:Wy,Transaction:Ky,WriteBatch:Hy,DocumentReference:yt,DocumentSnapshot:Js,Query:et,QueryDocumentSnapshot:Ys,QuerySnapshot:eu,CollectionReference:Ti,FieldPath:Fh,FieldValue:nr,setLogLevel:Zk,CACHE_SIZE_UNLIMITED:pk};function n0(n,e){n.INTERNAL.registerComponent(new wt("firestore-compat",t=>{const r=t.getProvider("app-compat").getImmediate(),i=t.getProvider("firestore").getImmediate();return e(r,i)},"PUBLIC").setServiceProps(Object.assign({},t0)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function r0(n){n0(n,(e,t)=>new Gy(e,t,new Xk)),n.registerVersion(Qk,Jk)}r0(Pn);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yy="firebasestorage.googleapis.com",Xy="storageBucket",i0=2*60*1e3,s0=10*60*1e3,o0=1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function v0(n,e,t){let r=1,i=null,s=null,o=!1,c=0;function l(){return c===2}let u=!1;function d(...C){u||(u=!0,e.apply(null,C))}function p(C){i=setTimeout(()=>{i=null,n(I,l())},C)}function g(){s&&clearTimeout(s)}function I(C,...U){if(u){g();return}if(C){g(),d.call(null,C,...U);return}if(l()||o){g(),d.call(null,C,...U);return}r<64&&(r*=2);let F;c===1?(c=2,F=0):F=(r+Math.random())*1e3,p(F)}let S=!1;function x(C){S||(S=!0,g(),!u&&(i!==null?(C||(c=2),clearTimeout(i),p(0)):C||(c=1)))}return p(0),s=setTimeout(()=>{o=!0,x(!0)},t),x}function I0(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class b0{constructor(e,t,r,i,s,o,c,l,u,d,p,g=!0){this.url_=e,this.method_=t,this.headers_=r,this.body_=i,this.successCodes_=s,this.additionalRetryCodes_=o,this.callback_=c,this.errorCallback_=l,this.timeout_=u,this.progressCallback_=d,this.connectionFactory_=p,this.retry=g,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((I,S)=>{this.resolve_=I,this.reject_=S,this.start_()})}start_(){const e=(r,i)=>{if(i){r(!1,new Ho(!1,null,!0));return}const s=this.connectionFactory_();this.pendingConnection_=s;const o=c=>{const l=c.loaded,u=c.lengthComputable?c.total:-1;this.progressCallback_!==null&&this.progressCallback_(l,u)};this.progressCallback_!==null&&s.addUploadProgressListener(o),s.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&s.removeUploadProgressListener(o),this.pendingConnection_=null;const c=s.getErrorCode()===lr.NO_ERROR,l=s.getStatus();if(!c||sv(l,this.additionalRetryCodes_)&&this.retry){const d=s.getErrorCode()===lr.ABORT;r(!1,new Ho(!1,null,d));return}const u=this.successCodes_.indexOf(l)!==-1;r(!0,new Ho(u,s))})},t=(r,i)=>{const s=this.resolve_,o=this.reject_,c=i.connection;if(i.wasSuccessCode)try{const l=this.callback_(c,c.getResponse());w0(l)?s(l):s()}catch(l){o(l)}else if(c!==null){const l=Uh();l.serverResponse=c.getErrorText(),this.errorCallback_?o(this.errorCallback_(c,l)):o(l)}else if(i.canceled){const l=this.appDelete_?nv():ev();o(l)}else{const l=Zy();o(l)}};this.canceled_?t(!1,new Ho(!1,null,!0)):this.backoffId_=v0(e,t,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&I0(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class Ho{constructor(e,t,r){this.wasSuccessCode=e,this.connection=t,this.canceled=!!r}}function A0(n,e){e!==null&&e.length>0&&(n.Authorization="Firebase "+e)}function R0(n,e){n["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function S0(n,e){e&&(n["X-Firebase-GMPID"]=e)}function P0(n,e){e!==null&&(n["X-Firebase-AppCheck"]=e)}function k0(n,e,t,r,i,s,o=!0){const c=iv(n.urlParams),l=n.url+c,u=Object.assign({},n.headers);return S0(u,e),A0(u,t),R0(u,s),P0(u,r),new b0(l,n.method,u,n.body,n.successCodes,n.additionalRetryCodes,n.handler,n.errorHandler,n.timeout,n.progressCallback,i,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C0(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function x0(...n){const e=C0();if(e!==void 0){const t=new e;for(let r=0;r<n.length;r++)t.append(n[r]);return t.getBlob()}else{if(Bh())return new Blob(n);throw new ge(ce.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function D0(n,e,t){return n.webkitSlice?n.webkitSlice(e,t):n.mozSlice?n.mozSlice(e,t):n.slice?n.slice(e,t):null}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N0(n){if(typeof atob>"u")throw _0("base-64");return atob(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vt={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class _l{constructor(e,t){this.data=e,this.contentType=t||null}}function ov(n,e){switch(n){case vt.RAW:return new _l(av(e));case vt.BASE64:case vt.BASE64URL:return new _l(cv(n,e));case vt.DATA_URL:return new _l(O0(e),L0(e))}throw Uh()}function av(n){const e=[];for(let t=0;t<n.length;t++){let r=n.charCodeAt(t);if(r<=127)e.push(r);else if(r<=2047)e.push(192|r>>6,128|r&63);else if((r&64512)===55296)if(!(t<n.length-1&&(n.charCodeAt(t+1)&64512)===56320))e.push(239,191,189);else{const s=r,o=n.charCodeAt(++t);r=65536|(s&1023)<<10|o&1023,e.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|r&63)}else(r&64512)===56320?e.push(239,191,189):e.push(224|r>>12,128|r>>6&63,128|r&63)}return new Uint8Array(e)}function V0(n){let e;try{e=decodeURIComponent(n)}catch{throw Ps(vt.DATA_URL,"Malformed data URL.")}return av(e)}function cv(n,e){switch(n){case vt.BASE64:{const i=e.indexOf("-")!==-1,s=e.indexOf("_")!==-1;if(i||s)throw Ps(n,"Invalid character '"+(i?"-":"_")+"' found: is it base64url encoded?");break}case vt.BASE64URL:{const i=e.indexOf("+")!==-1,s=e.indexOf("/")!==-1;if(i||s)throw Ps(n,"Invalid character '"+(i?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let t;try{t=N0(e)}catch(i){throw i.message.includes("polyfill")?i:Ps(n,"Invalid character found")}const r=new Uint8Array(t.length);for(let i=0;i<t.length;i++)r[i]=t.charCodeAt(i);return r}class lv{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(t===null)throw Ps(vt.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const r=t[1]||null;r!=null&&(this.base64=M0(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-7):r),this.rest=e.substring(e.indexOf(",")+1)}}function O0(n){const e=new lv(n);return e.base64?cv(vt.BASE64,e.rest):V0(e.rest)}function L0(n){return new lv(n).contentType}function M0(n,e){return n.length>=e.length?n.substring(n.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qh(n){let e;try{e=JSON.parse(n)}catch{return null}return T0(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F0(n){if(n.length===0)return null;const e=n.lastIndexOf("/");return e===-1?"":n.slice(0,e)}function U0(n,e){const t=e.split("/").filter(r=>r.length>0).join("/");return n.length===0?t:n+"/"+t}function uv(n){const e=n.lastIndexOf("/",n.length-2);return e===-1?n:n.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B0(n,e){return e}class Ze{constructor(e,t,r,i){this.server=e,this.local=t||e,this.writable=!!r,this.xform=i||B0}}let Qo=null;function q0(n){return!Rc(n)||n.length<2?n:uv(n)}function Sc(){if(Qo)return Qo;const n=[];n.push(new Ze("bucket")),n.push(new Ze("generation")),n.push(new Ze("metageneration")),n.push(new Ze("name","fullPath",!0));function e(s,o){return q0(o)}const t=new Ze("name");t.xform=e,n.push(t);function r(s,o){return o!==void 0?Number(o):o}const i=new Ze("size");return i.xform=r,n.push(i),n.push(new Ze("timeCreated")),n.push(new Ze("updated")),n.push(new Ze("md5Hash",null,!0)),n.push(new Ze("cacheControl",null,!0)),n.push(new Ze("contentDisposition",null,!0)),n.push(new Ze("contentEncoding",null,!0)),n.push(new Ze("contentLanguage",null,!0)),n.push(new Ze("contentType",null,!0)),n.push(new Ze("metadata","customMetadata",!0)),Qo=n,Qo}function $0(n,e){function t(){const r=n.bucket,i=n.fullPath,s=new Qe(r,i);return e._makeStorageReference(s)}Object.defineProperty(n,"ref",{get:t})}function z0(n,e,t){const r={};r.type="file";const i=t.length;for(let s=0;s<i;s++){const o=t[s];r[o.local]=o.xform(r,e[o.server])}return $0(r,n),r}function hv(n,e,t){const r=qh(e);return r===null?null:z0(n,r,t)}function j0(n,e,t,r){const i=qh(e);if(i===null||!Rc(i.downloadTokens))return null;const s=i.downloadTokens;if(s.length===0)return null;const o=encodeURIComponent;return s.split(",").map(u=>{const d=n.bucket,p=n.fullPath,g="/b/"+o(d)+"/o/"+o(p),I=jn(g,t,r),S=iv({alt:"media",token:u});return I+S})[0]}function $h(n,e){const t={},r=e.length;for(let i=0;i<r;i++){const s=e[i];s.writable&&(t[s.server]=n[s.local])}return JSON.stringify(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bp="prefixes",qp="items";function W0(n,e,t){const r={prefixes:[],items:[],nextPageToken:t.nextPageToken};if(t[Bp])for(const i of t[Bp]){const s=i.replace(/\/$/,""),o=n._makeStorageReference(new Qe(e,s));r.prefixes.push(o)}if(t[qp])for(const i of t[qp]){const s=n._makeStorageReference(new Qe(e,i.name));r.items.push(s)}return r}function G0(n,e,t){const r=qh(t);return r===null?null:W0(n,e,r)}class un{constructor(e,t,r,i){this.url=e,this.method=t,this.handler=r,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lt(n){if(!n)throw Uh()}function Pc(n,e){function t(r,i){const s=hv(n,i,e);return Lt(s!==null),s}return t}function K0(n,e){function t(r,i){const s=G0(n,e,i);return Lt(s!==null),s}return t}function H0(n,e){function t(r,i){const s=hv(n,i,e);return Lt(s!==null),j0(s,i,n.host,n._protocol)}return t}function Ui(n){function e(t,r){let i;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?i=u0():i=l0():t.getStatus()===402?i=c0(n.bucket):t.getStatus()===403?i=h0(n.path):i=r,i.status=t.getStatus(),i.serverResponse=r.serverResponse,i}return e}function kc(n){const e=Ui(n);function t(r,i){let s=e(r,i);return r.getStatus()===404&&(s=a0(n.path)),s.serverResponse=i.serverResponse,s}return t}function dv(n,e,t){const r=e.fullServerUrl(),i=jn(r,n.host,n._protocol),s="GET",o=n.maxOperationRetryTime,c=new un(i,s,Pc(n,t),o);return c.errorHandler=kc(e),c}function Q0(n,e,t,r,i){const s={};e.isRoot?s.prefix="":s.prefix=e.path+"/",t.length>0&&(s.delimiter=t),r&&(s.pageToken=r),i&&(s.maxResults=i);const o=e.bucketOnlyServerUrl(),c=jn(o,n.host,n._protocol),l="GET",u=n.maxOperationRetryTime,d=new un(c,l,K0(n,e.bucket),u);return d.urlParams=s,d.errorHandler=Ui(e),d}function J0(n,e,t){const r=e.fullServerUrl(),i=jn(r,n.host,n._protocol),s="GET",o=n.maxOperationRetryTime,c=new un(i,s,H0(n,t),o);return c.errorHandler=kc(e),c}function Y0(n,e,t,r){const i=e.fullServerUrl(),s=jn(i,n.host,n._protocol),o="PATCH",c=$h(t,r),l={"Content-Type":"application/json; charset=utf-8"},u=n.maxOperationRetryTime,d=new un(s,o,Pc(n,r),u);return d.headers=l,d.body=c,d.errorHandler=kc(e),d}function X0(n,e){const t=e.fullServerUrl(),r=jn(t,n.host,n._protocol),i="DELETE",s=n.maxOperationRetryTime;function o(l,u){}const c=new un(r,i,o,s);return c.successCodes=[200,204],c.errorHandler=kc(e),c}function Z0(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function fv(n,e,t){const r=Object.assign({},t);return r.fullPath=n.path,r.size=e.size(),r.contentType||(r.contentType=Z0(null,e)),r}function eC(n,e,t,r,i){const s=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function c(){let F="";for(let W=0;W<2;W++)F=F+Math.random().toString().slice(2);return F}const l=c();o["Content-Type"]="multipart/related; boundary="+l;const u=fv(e,r,i),d=$h(u,t),p="--"+l+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sC{constructor(e,t,r){if(E0(e)||t!=null||r!=null)this.next=e,this.error=t??void 0,this.complete=r??void 0;else{const s=e;this.next=s.next,this.error=s.error,this.complete=s.complete}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tr{constructor(e,t){this._service=e,t instanceof Qe?this._location=t:this._location=Qe.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Tr(e,t)}get root(){const e=new Qe(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return uv(this._location.path)}get storage(){return this._service}get parent(){const e=F0(this._location.path);if(e===null)return null;const t=new Qe(this._location.bucket,e);return new Tr(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw rv(e)}}function cC(n,e,t){return n._throwIfRoot("uploadBytesResumable"),new pv(n,new jt(e),t)}function lC(n){const e={prefixes:[],items:[]};return mv(n,e).then(()=>e)}async function mv(n,e,t){const i=await gv(n,{pageToken:t});e.prefixes.push(...i.prefixes),e.items.push(...i.items),i.nextPageToken!=null&&await mv(n,e,i.nextPageToken)}function gv(n,e){e!=null&&typeof e.maxResults=="number"&&tu("options.maxResults",1,1e3,e.maxResults);const t=e||{},r=Q0(n.storage,n._location,"/",t.pageToken,t.maxResults);return n.storage.makeRequestWithTokens(r,Ct)}function uC(n){n._throwIfRoot("getMetadata");const e=dv(n.storage,n._location,Sc());return n.storage.makeRequestWithTokens(e,Ct)}function hC(n,e){n._throwIfRoot("updateMetadata");const t=Y0(n.storage,n._location,e,Sc());return n.storage.makeRequestWithTokens(t,Ct)}function dC(n){n._throwIfRoot("getDownloadURL");const e=J0(n.storage,n._location,Sc());return n.storage.makeRequestWithTokens(e,Ct).then(t=>{if(t===null)throw g0();return t})}function fC(n){n._throwIfRoot("deleteObject");const e=X0(n.storage,n._location);return n.storage.makeRequestWithTokens(e,Ct)}function _v(n,e){const t=U0(n._location.path,e),r=new Qe(n._location.bucket,t);return new Tr(n.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const xC="storage-compat";function DC(n,{instanceIdentifier:e}){const t=n.getProvider("app-compat").getImmediate(),r=n.getProvider("storage").getImmediate({identifier:e});return new wv(t,r)}function NC(n){const e={TaskState:nt,TaskEvent:iC,StringFormat:vt,Storage:wv,Reference:Yt};n.INTERNAL.registerComponent(new wt(xC,DC,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),n.registerVersion(kC,CC)}NC(Pn);const VC={apiKey:"AIzaSyDaXyH96jd-k3r1MRaDiN9KWo2oN2lpaW4",authDomain:"editor-app-29ca6.firebaseapp.com",projectId:"editor-app-29ca6",storageBucket:"editor-app-29ca6.firebasestorage.app",messagingSenderId:"666399306180",appId:"1:666399306180:web:619b5765655311d4a03491"};Pn.apps.length||Pn.initializeApp(VC);const OC=mk(),LC=fA();RC();console.log("[Firebase] Initialized via Hybrid (Compat+Modular)");function Se(){return OC}function Io(){return LC}function MC(){console.log("[Firebase] Explicit initialization called.")}const Ht={selectedWorkId:localStorage.getItem("plotter_selectedWorkId"),currentTab:localStorage.getItem("plotter_currentTab")||"top",lastActiveTab:localStorage.getItem("plotter_lastActiveTab")||"plot",currentUser:null,isAuthReady:!1,listeners:[]};function Qt(n){Object.assign(Ht,n),n.currentTab&&(localStorage.setItem("plotter_currentTab",n.currentTab),n.currentTab!=="top"&&(Ht.lastActiveTab=n.currentTab,localStorage.setItem("plotter_lastActiveTab",n.currentTab))),n.hasOwnProperty("selectedWorkId")&&(Ht.selectedWorkId?localStorage.setItem("plotter_selectedWorkId",Ht.selectedWorkId):localStorage.removeItem("plotter_selectedWorkId")),console.log("[State] 更新:",n),FC()}function xe(){return{...Ht}}function Bi(n){return Ht.listeners.push(n),n(xe()),()=>{Ht.listeners=Ht.listeners.filter(e=>e!==n)}}function FC(){const n=xe();Ht.listeners.forEach(e=>e(n))}function UC(){const n=Io(),e=document.getElementById("google-login-btn");e&&e.addEventListener("click",BC);const t=document.querySelector(".main-header button");t&&t.addEventListener("click",qC),xT(n,r=>{r?(console.log("[Auth] ログイン完了:",r.displayName),Qt({currentUser:r,isAuthReady:!0})):(console.log("[Auth] ログアウト状態"),Qt({currentUser:null,isAuthReady:!0}))})}async function BC(){const n=Io(),e=new At;try{await ug(n,e)}catch(t){console.error("[Auth] ログインエラー:",t)}}async function qC(){const n=Io();try{await DT(n)}catch(e){console.error("[Auth] ログアウトエラー:",e)}}function $C(){Bi(n=>{zC(n),jC(n)}),WC(),document.addEventListener("click",n=>{n.target.classList.contains("back-to-top")&&Qt({currentTab:"top",selectedWorkId:null})})}function zC(n){const e=document.getElementById("login-screen"),t=document.getElementById("main-app");if(!n.isAuthReady){e&&(e.style.display="none"),t&&(t.style.display="none");return}n.currentUser?(e&&(e.style.display="none"),t&&(t.style.display="block")):(e&&(e.style.display="flex"),t&&(t.style.display="none"))}function jC(n){const e=n.currentTab||"top";["top","work-info","plot","characters","memo"].forEach(o=>{const c=document.getElementById(`tab-${o}`);c&&c.classList.toggle("active",e===o)}),document.querySelectorAll(".tab-nav .tab-btn").forEach(o=>{const c=o.getAttribute("data-tab");o.classList.toggle("active",e===c)});const i=document.querySelector(".tab-nav"),s=document.getElementById("common-back-to-top");i&&(e==="top"?(i.classList.add("hidden"),s&&(s.style.display="none")):(i.classList.remove("hidden"),s&&(s.style.display="block")))}function WC(){document.querySelectorAll(".tab-nav .tab-btn").forEach(e=>{const t=e.getAttribute("data-tab");e.addEventListener("click",()=>{Qt({currentTab:t})})})}function Le(n){return n?n.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[e]):""}function Jp(n,e=!1){if(!n)return"---";const t=n.toDate?n.toDate():new Date(n),r=t.getFullYear(),i=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");if(!e)return`${r}/${i}/${s}`;const o=String(t.getHours()).padStart(2,"0"),c=String(t.getMinutes()).padStart(2,"0");return`${r}/${i}/${s} ${o}:${c}`}function wo(n){const e=typeof n=="string"?document.querySelector(n):n;if(e)for(;e.firstChild;)e.removeChild(e.firstChild)}function GC(n,e=300,t=300,r=.7){return new Promise((i,s)=>{const o=new FileReader;o.readAsDataURL(n),o.onload=c=>{const l=new Image;l.src=c.target.result,l.onload=()=>{const u=document.createElement("canvas");let d=l.width,p=l.height;d>p?d>e&&(p*=e/d,d=e):p>t&&(d*=t/p,p=t),u.width=d,u.height=p,u.getContext("2d").drawImage(l,0,0,d,p),i(u.toDataURL("image/jpeg",r))},l.onerror=s},o.onerror=s})}function Tt(n){n&&(n.style.height="auto",n.style.height=n.scrollHeight+"px")}let ur=null,pa="normal",_t=[];function KC(){window.plotter_openPlotEditor=nu,window.plotter_openPlotView=HC,window.plotter_deletePlot=YC,window.plotter_movePlot=XC;const n=document.getElementById("plot-save-btn");n&&n.addEventListener("click",JC);const e=document.getElementById("plot-edit-back");e&&e.addEventListener("click",ru);const t=document.getElementById("plot-type-normal");t&&t.addEventListener("click",()=>Ma("normal"));const r=document.getElementById("plot-type-timeline");r&&r.addEventListener("click",()=>Ma("timeline"));const i=document.getElementById("plot-timeline-add-btn");i&&i.addEventListener("click",()=>QC());const s=document.getElementById("plot-content");s&&s.addEventListener("input",l=>Tt(l.target));const o=document.getElementById("plot-view-back");o&&o.addEventListener("click",ru);const c=document.getElementById("plot-view-edit-btn");c&&c.addEventListener("click",()=>nu(ur))}async function HC(n){const e=xe();if(!e.selectedWorkId)return;ur=n,ur=n;const t=Se(),r=fe(t,"works",e.selectedWorkId,"plots",n),i=await xr(r);if(!i.exists())return;const s=i.data();document.getElementById("plot-list-view").style.display="none",document.getElementById("plot-edit-view").style.display="none",document.getElementById("plot-view-view").style.display="block",document.getElementById("plot-view-title").textContent=s.title||"無題";const o=document.getElementById("plot-view-basic-content-area"),c=document.getElementById("plot-view-basic-content"),l=document.getElementById("plot-view-timeline-content"),u=document.getElementById("plot-view-timeline-list");s.type==="timeline"?(o&&(o.style.display="none"),l.style.display="block",u.innerHTML=(s.timelineItems||[]).map(d=>`
        ...
        `;const i=r.querySelector(".tl-date"),s=r.querySelector(".tl-content");i.addEventListener("input",o=>{_t[t].date=o.target.value,r.querySelector(".collapsible-header div").textContent=o.target.value||"（空の日時）"}),s.addEventListener("input",o=>{_t[t].content=o.target.value,Tt(o.target)}),setTimeout(()=>Tt(s),0),r.querySelector(".tl-up").addEventListener("click",()=>{if(t>0){const o=_t[t];_t[t]=_t[t-1],_t[t-1]=o,Fa()}}),r.querySelector(".tl-del").addEventListener("click",()=>{confirm("本当に削除しますか？")&&(_t.splice(t,1),Fa())}),n.appendChild(r)}))}async function JC(){const n=xe(),e=document.getElementById("plot-title").value.trim(),t=document.getElementById("plot-content").value;if(e)try{const r=window.firebase,i={title:e,content:pa==="timeline"?"":t,type:pa,timelineItems:pa==="timeline"?_t:[],updatedAt:r.firestore.FieldValue.serverTimestamp()},s=Se(),o=gt(s,"works",n.selectedWorkId,"plots");let c=ur;if(ur){const l=fe(s,"works",n.selectedWorkId,"plots",ur);await wr(l,i)}else{const l=Oe(o),u=await Nr(l);i.order=u.size,i.createdAt=Fn(),c=(await vo(o,i)).id}ru()}catch(r){console.error("[PlotEditor] 保存エラー:",r)}}function ru(){document.getElementById("plot-list-view").style.display="block",document.getElementById("plot-edit-view").style.display="none",document.getElementById("plot-view-view").style.display="none"}async function YC(n){if(!confirm("本当に削除しますか？"))return;const e=xe(),t=Se();try{const r=fe(t,"works",e.selectedWorkId,"plots",n);await bc(r)}catch(r){console.error("[PlotEditor] 削除エラー:",r)}}async function XC(n,e){const t=xe(),r=Se(),i=gt(r,"works",t.selectedWorkId,"plots");try{const s=Oe(i,Cr("order","asc")),o=await Nr(s),c=[];o.forEach(S=>c.push({id:S.id,...S.data()}));const l=c.findIndex(S=>S.id===n);if(l===-1)return;const u=l+e;if(u<0||u>=c.length)return;const d=c[u],p=Lh(r),g=fe(r,"works",t.selectedWorkId,"plots",n),I=fe(r,"works",t.selectedWorkId,"plots",d.id);p.update(g,{order:u}),p.update(I,{order:l}),await p.commit()}catch(s){console.error("[PlotEditor] 並び替えエラー:",s)}}let Yo=null;function ZC(){const n=document.getElementById("plot-new-btn");n&&n.addEventListener("click",()=>nu()),Bi(e=>{e.currentTab==="plot"&&ex(e)})}function ex(n){const e=document.getElementById("plot-list-container");if(!e)return;if(Yo&&(Yo(),Yo=null),!n.selectedWorkId){e.innerHTML='<div style="text-align:center; padding:40px; color:#666;">作品を選択してください</div>';return}const t=Se(),r=gt(t,"works",n.selectedWorkId,"plots"),i=Oe(r,Cr("order","asc"));Yo=Mi(i,s=>{tx(s,e)},s=>{console.error("[PlotList] プロット監視エラー:",s)})}function tx(n,e){if(wo(e),n.empty){e.innerHTML='<div style="text-align:center; padding:40px; color:#666;">プロットがありません</div>';return}n.forEach(t=>{const r={id:t.id,...t.data()},i=nx(r);e.appendChild(i)})}function nx(n){const e=document.createElement("div");e.className="collapsible-container collapsed card-retro",e.style.padding="0",e.style.marginBottom="15px";const t=()=>n.type==="timeline"?(n.timelineItems||[]).slice(0,3).map(i=>`
    ...
    `;const r=()=>{const i=e.classList.toggle("collapsed"),s=e.querySelector(".collapsible-content"),o=e.querySelector(".toggle-icon");o.textContent=i?"＋":"－",i?(s.classList.add("summary-mode"),s.innerHTML=t()):(s.classList.remove("summary-mode"),n.type==="timeline"?rx(n,s):s.innerHTML=`<div style="color:#eee; white-space:pre-wrap; font-size:1.05rem; line-height:1.6;">${Le(n.content||"")}</div>`)};return e.querySelector(".collapsible-header").addEventListener("click",r),e.querySelector(".collapsible-content").addEventListener("click",i=>{e.classList.contains("collapsed")&&r()}),e.querySelector(".btn-edit").addEventListener("click",i=>{i.stopPropagation(),window.plotter_openPlotEditor&&window.plotter_openPlotEditor(n.id)}),e.querySelector(".btn-up").addEventListener("click",i=>{i.stopPropagation(),window.plotter_movePlot&&window.plotter_movePlot(n.id,-1)}),e.querySelector(".btn-delete").addEventListener("click",i=>{i.stopPropagation(),window.plotter_deletePlot&&window.plotter_deletePlot(n.id)}),e}function rx(n,e){e.innerHTML=(n.timelineItems||[]).map(t=>`
